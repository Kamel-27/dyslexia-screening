...
export const QUESTION_BANK: Question[] = [
  ...
  },
  {
    ...
    audioUrl: "/gamified-test/questions/q31.mp3",
    interactionType: "typedSequenceRecall",
    gridSize: 3,
    targetToken: "cat",
    targetRepeatCount: 1,
    variants: [
      {
        ...
        targetToken: "dog",
        distractorTokens: [],
        audioUrl: "/gamified-test/questions/q31_v2.mp3",
      },
      {
        visualCue: "",
        targetToken: "sun",
        distractorTokens: [],
        audioUrl: "/gamified-test/questions/q31_v3.mp3",
      },
      {
        visualCue: "",
        targetToken: "hat",
        distractorTokens: [],
        audioUrl: "/gamified-test/questions/q31_v4.mp3",
      },
    ],
  },
  {
    ...
    audioUrl: "/gamified-test/questions/q32.mp3",
    interactionType: "typedSequenceRecall",
    gridSize: 3,
    targetToken: "savi",
    targetRepeatCount: 1,
    variants: [
      {
        ...
        targetToken: "luno",
        distractorTokens: [],
        audioUrl: "/gamified-test/questions/q32_v2.mp3",
      },
      {
        visualCue: "",
        targetToken: "mibo",
        distractorTokens: [],
        audioUrl: "/gamified-test/questions/q32_v3.mp3",
      },
      {
        visualCue: "",
        targetToken: "fado",
        distractorTokens: [],
        audioUrl: "/gamified-test/questions/q32_v4.mp3",
      },
    ],
  },
];
